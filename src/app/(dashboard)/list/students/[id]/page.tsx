    ...
    <div className='flex-1 p-4 flex flex-col gap-4 xl:flex-row'>
      ...
      <div className="bg-white p-4 rounded-md">
        ...
        <div className="mt-2 flex gap-4 flex-wrap text-xs text-gray-500">
          <Link href="/" className="p-3 rounded-md bg-xSkyLight">Student&apos;s Lessons</Link>
          <Link href="/" className="p-3 rounded-md bg-xPurpleLight">Student&apos;s Teachers</Link>
          <Link href="/" className="p-3 rounded-md bg-xYellowLight">Student&apos;s Exams</Link>
          <Link href="/" className="p-3 rounded-md bg-pink-50">Student&apos;s Assignments</Link>
          <Link href="/" className="p-3 rounded-md bg-xSkyLight">Student&apos;s Results</Link>
        </div>
      </div>
      {/* Performance */}
      <StudentPerformance />
